...
<html>
	...
	<body>
			...
			<table class="table table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="/CourseDesign/DownServlet?name=${item.en_filename}">${item.en_filename}</a>
						</td>
						<td>
							<a href="#" onclick="modalupdate('${item.en_tea_name }','${item.en_topic_name}')">确认申请</a>
						</td>
					</tr>
		...
		<!--删除操作的模态框-->
	<form action="/CourseDesign/TopicSelectServlet" method="post">
