...
<html>
	...
	<body>
		...
		<!-- 删除操作的模态框，对话框 -->
	<form action="/CourseDesign/TeacherDeleteServlet" method="post" class="form-horizontal">
       ...
       <form action="/CourseDesign/TeacherUpdateServlet"method="post"class="form-horizontal">
