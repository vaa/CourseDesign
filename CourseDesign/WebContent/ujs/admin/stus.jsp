...
<html>
				...
				<tbody>
					<c:forEach var = "item" items="${sessionScope.stus }">
						<tr>
					    	...
					    	<a href="#" onclick="showUpdate('${item.stu_no}','${item.stu_name}','${item.stu_pwd}')">修改</a>
					    </td>
						</tr>
					</c:forEach>
	...
	<form action="/CourseDesign/StudentDeleteServlet" method="post" class="form-horizontal">
	    ...
	    <form action="/CourseDesign/StudentUpdateServlet" method="post" class="form-horizontal">
