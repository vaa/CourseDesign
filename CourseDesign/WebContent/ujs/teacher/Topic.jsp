...
<html>
	...
	<body>
				...
				<tbody>
				  <c:forEach var="item" items="${sessionScope.Topic}">
					<tr>
						...
						<td>${item.en_filename}</td>
						<td>
							<a href="#" onclick="modalupload('${item.en_id}')">上传</a>
						</td>
						<td>
							<a href="#" onclick="modalupdate('${item.en_tea_name}','${item.en_topic_name}','${item.en_topic_content }')">修改</a>
							<a href="#" onclick="modaldelete('${item.en_topic_name}')">删除</a>
						</td>
					</tr>
					</c:forEach>
				</tbody>
		...
		<!--//修改操作的模态框-->
		<form action="/CourseDesign/TopicUpdateServlet" method="post" class="form-horizontal">
		...
		<!--删除操作的模态框-->
		<form action="/CourseDesign/TopicDeleteServlet" method="post" class="form-horizontal">
		...
		<form action="/CourseDesign/UploadFileServlet" enctype="multipart/form-data" method="post" class="form-horizontal">
